                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <ul class="pagination pagination-sm pagination-gutter">
                                            <c:forEach begin="1" end="${END_PAGE}" var ="page">
                                                <c:if test="${action.action eq AccountList}">
                                                ...
                                                <c:forEach begin="1" end="${END_PAGE_EACH}" var ="page">
                                                    <c:if test="${action.action eq SearchAccountByAdmin}">
                                                    <li class="page-item <c:if test="${param.index eq page}"> active </c:if>" >
                                                        <a class="page-link" href="MainController?action=SearchAccountByAdmin&searchAccountByAdmin=${param.searchAccountByAdmin}&index=${page}">${page}</a>
                                                    </c:if>
                                                </c:forEach>
                                        </ul>                                        
